...
\end{itemize}
	...
	All'interno dello stato DETECTED viene controllato se la differenza tra la distanza corrente e la distanza precedente e' maggiore di un certo delta fissato da noi per capire se un oggetto e' "finito orizzontalmente" allora il ledDetected viene spento e si torna allo stato di SCANNING; inoltre anche se si arriva ai limiti di movimeno del servo si ritorna allo stato di SCANNING.
